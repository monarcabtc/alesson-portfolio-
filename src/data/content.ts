...
export const experience = [
  ...
  },
  {
    ...
    bullets: [
      "Led digital adoption and social strategy across consumer business units; partnered with leadership to deliver measurable engagement and change programmes across a multi-brand environment.",
      "Managed internal stakeholder relationships and external vendors to deliver transformation initiatives on time and within budget.",
    ],
  },
  {
    title: "Senior Digital Project Manager",
  ...
  },
  {
    ...
    bullets: [
      "Launched AEM-based digital platform with Adobe; delivered AI-powered customer engagement tools and aligned business units on digital strategy tied to commercial KPIs.",
    ],
  },
];
